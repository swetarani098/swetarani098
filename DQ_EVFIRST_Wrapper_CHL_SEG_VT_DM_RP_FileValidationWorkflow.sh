...
# DQ_EVFIRST_Wrapper_CHL_SEG_VT_DM_RP_FileValidationWorkflow.sh   Cognizant DQ Developent Team   20-Mar-2018 #
# Version History:                                                                                       #
# 1.1 - 20-Mar-2018 - Initial version                                                                    #
##########################################################################################################
...
logfile='DQ_EVFIRST_Wrapper_CHL_SEG_VT_DM_RP_FileValidationWorkflow_'$checker_timestamp'.log'
...
#echo 1.1
v_source_file_runtime=$meta_file_path'/DQ_EVFIRST_Source_File_Metadata_CHL_VT_DM_RP_RunTime.csv'
...
#echo 4
    ...
    BASE_PARAM_FILE_NAME="$FILE_FORMAT"'_PARAM.XML'
...
##BEGIN: added on 07192018 for NORMALIZER requirement
...
##END: added on 07192018 for NORMALIZER requirement
...
f_gen_log "Calling CHL_VT_DM_RP post processng script in a different thread"

cd $script_file_path

sh DQ_EVFIRST_PostProcessing_CHL_SEG_VT_DM_RP.sh

#######BEGIN Dt. 16-JAN-2019 added for DQ_Failed marked load tracking
if [ -s $meta_file_path'/DQ_EVFIRST_Source_File_Metadata_CHL_VT_DM_RP_RunTime.failure' ];
then
        f_gen_log "Entered DQ_Failed marked load tracking"
        f_gen_log "Failure log has generated : $meta_file_path'/DQ_EVFIRST_Source_File_Metadata_CHL_VT_DM_RP_RunTime.failure"
        f_gen_log "ERROR CODE 93 - DQ_Failed marked load tracking"
        mv $meta_file_path/DQ_EVFIRST_Source_File_Metadata_CHL_VT_DM_RP_RunTime.failure $archive_file_path'DQ_EVFIRST_Source_File_Metadata_CHL_VT_DM_RP_RunTime.failure_'$checker_timestamp
        mv $meta_file_path/DQ_EVFIRST_Source_File_Metadata_CHL_VT_DM_RP_RunTime.csv $archive_file_path'DQ_EVFIRST_Source_File_Metadata_CHL_VT_DM_RP_RunTime.csv_'$checker_timestamp
        echo 93
        exit 93
else
        f_gen_log "No issue with wf"
fi

mv $meta_file_path/DQ_EVFIRST_Source_File_Metadata_CHL_VT_DM_RP_RunTime.csv $archive_file_path'DQ_EVFIRST_Source_File_Metadata_CHL_VT_DM_RP_RunTime.csv_'$checker_timestamp
######END Dt. 16-JAN-2019 added for DQ_Failed marked load tracking
