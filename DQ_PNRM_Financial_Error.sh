...
sh /opt/PowerCenter/server/bin/infacmd.sh wfs startWorkflow -dn DMN_GRID_DQ_DEV -sn DIS_SVC_DQ_DEV -un GPMBatch -pd metlife123 -a app_panorama_financial_GCS -wf wf_DQ_PNRM_Financial_Error -w true -pf $parm_file_path/wf_DQ_PNRM_Param_Financial_Error_Runtime_$date.xml 
